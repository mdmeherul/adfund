...
class DBHelper {
    ...
    public function updateEnv(array $replace_array) {
        ...
        $env_file_content_string = File::get($env_file, true);

        dd($env_file_content_string);
        ...
        dd($string_content, $env_content, $lines, File::put($env_file, $string_content));
