            ...
            <div class="col-xl-2 col-lg-3 col-md-6 mb-30">
                <div class="footer-widget">
                    ...
                    <ul class="footer-list">
                        ...
                        <li><a href="{{ setRoute('campaign') }}">{{ __('Campaign') }} <i class="las la-arrow-right"></i></a></li>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                <div class="footer-widget">
                    ...
                    <form class="newsletter-form" method="POST" id="newsletter-form">
                        ...
                        <button type="submit" class="btn--base"><i class="fa fa-spinner d-none fa-pulse fa-fw"></i> {{ __('Subscribe') }}</button>
                    </form>
                </div>
            </div>
        </div>
        <div class="copyright-area">
            <p>{{ __(@$footer->value->language->$defualt->footer_text) }} <a href="{{ url('/') }}"><span>{{ $basic_settings->site_name ?? 'AdFund' }}.</span></a></p>
        </div>
    </div>
</footer>
