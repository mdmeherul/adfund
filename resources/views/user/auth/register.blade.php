...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Start Account
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<section class="account-section bg_img" data-background="{{ get_image(@$register->value->images->register_image,'site-section') }}">
                        ...
                        @if (@$basic_settings->agree_policy == 1)
                            <div class="col-lg-12 form-group">
                                <div class="form-group custom-check-group mb-0">
                                    ...
                                    <label for="level-1" class="mb-0">{{ __("I have read agreed with the") }} <a href="{{ url(@$register->value->agree_policy_link) }}" class="text--base">{{ @$register->value->language->$defualt->agree_policy_title }}</a></label>
                                </div>
                            </div>
                        @endif
