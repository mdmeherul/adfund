...
@section('content')
   <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Start Account
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<section class="account-section bg_img" data-background="{{ get_image(@$login->value->images->login_image,'site-section') }}">
                        ...
                        @if (@$basic_settings->user_registration == 1)
                            <div class="col-lg-12 text-center">
                                <div class="account-item mt-10">
                                    <label>
                                        {{ __("don THave Account") }}  <a href="{{ setRoute('user.register') }}" class="text--base">{{ __("Register Now") }}</a>
                                        </label>
                                </div>
                            </div>
                        @endif
